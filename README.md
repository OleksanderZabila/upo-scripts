...
| 3 | Назва | Колонка C |
| 4 | Адреса | Колонка D |
| 5 | Час прийому виклику | Колонка G вхідного файлу (час прибуття на виклик) |
| 6 | Наряд | Колонка F |
| 7 | Час прибуття | Колонка H вхідного файлу (час відбуття) |
...
**v2.9** — виправлено маппінг колонок: «Час прийому виклику» (col E) тепер береться з колонки G вхідного файлу, «Час прибуття» (col G) — з колонки H; тривалість = H − G замість G − B.
