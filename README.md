...
**v2.7** — підкреслено окремий рядок для готового файлу: розділювач + жирний жовтий підпис «ⓘ Готовий файл — лише перегляд статистики». Структура виходу залишається 9 колонок (без додаткового опису).
